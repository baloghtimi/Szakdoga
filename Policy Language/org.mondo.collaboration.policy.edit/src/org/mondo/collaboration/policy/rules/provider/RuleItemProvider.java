...
/**
 * This is the item provider adapter for a {@link org.mondo.collaboration.policy.rules.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulesPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_access_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_access_feature", "_UI_Rule_type"),
				 RulesPackage.Literals.RULE__ACCESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_operation_feature", "_UI_Rule_type"),
				 RulesPackage.Literals.RULE__OPERATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulesPackage.Literals.RULE__ROLES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_pattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_pattern_feature", "_UI_Rule_type"),
				 RulesPackage.Literals.RULE__PATTERN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulesPackage.Literals.RULE__PRIORITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RulesPackage.Literals.RULE__ASSET);
			childrenFeatures.add(RulesPackage.Literals.RULE__BINDINGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.RULE__ASSET,
				 RulesFactory.eINSTANCE.createModelFact()));

		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.RULE__ASSET,
				 RulesFactory.eINSTANCE.createObjectFact()));

		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.RULE__ASSET,
				 RulesFactory.eINSTANCE.createReferenceFact()));

		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.RULE__ASSET,
				 RulesFactory.eINSTANCE.createAttributeFact()));

		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.RULE__BINDINGS,
				 RulesFactory.eINSTANCE.createBinding()));
	}
