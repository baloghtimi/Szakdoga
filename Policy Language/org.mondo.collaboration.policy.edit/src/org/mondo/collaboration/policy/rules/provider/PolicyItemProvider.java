...
/**
 * This is the item provider adapter for a {@link org.mondo.collaboration.policy.rules.Policy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolicyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulesPackage.Literals.POLICY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Policy_access_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Policy_access_feature", "_UI_Policy_type"),
				 RulesPackage.Literals.POLICY__ACCESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Policy_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Policy_operation_feature", "_UI_Policy_type"),
				 RulesPackage.Literals.POLICY__OPERATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addResolutionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Policy_resolution_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Policy_resolution_feature", "_UI_Policy_type"),
				 RulesPackage.Literals.POLICY__RESOLUTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RulesPackage.Literals.POLICY__RULES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.POLICY__RULES,
				 RulesFactory.eINSTANCE.createRule()));
	}
