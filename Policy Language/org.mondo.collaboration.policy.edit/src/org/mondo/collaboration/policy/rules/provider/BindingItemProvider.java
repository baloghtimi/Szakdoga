...
/**
 * This is the item provider adapter for a {@link org.mondo.collaboration.policy.rules.Binding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindingItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binding_variable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binding_variable_feature", "_UI_Binding_type"),
				 RulesPackage.Literals.BINDING__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RulesPackage.Literals.BINDING__BIND);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.BINDING__BIND,
				 RulesFactory.eINSTANCE.createBind()));
	}
