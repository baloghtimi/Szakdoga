...
/**
 * This is the item provider adapter for a {@link org.mondo.collaboration.policy.rules.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider extends RoleItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_roles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_roles_feature", "_UI_Group_type"),
				 RulesPackage.Literals.GROUP__ROLES,
				 true,
				 false,
				 true,
				 null,
