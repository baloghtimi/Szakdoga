...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Resolution Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.xtext.policy.rules.RulesPackage#getResolutionType()
 * @model
 * @generated
 */
...
{
  /**
   * The '<em><b>RESTRICTIVE</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RESTRICTIVE_VALUE
   * @generated
   * @ordered
   */
  RESTRICTIVE(0, "RESTRICTIVE", "restrictive"),
   ...
   * @ordered
   */
  PERMISSIVE(1, "PERMISSIVE", "permissive");

  /**
   * The '<em><b>RESTRICTIVE</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>RESTRICTIVE</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RESTRICTIVE
   * @model literal="restrictive"
   * @generated
   * @ordered
   */
  public static final int RESTRICTIVE_VALUE = 0;
   ...
   * @generated
   */
  private static final ResolutionType[] VALUES_ARRAY =
    new ResolutionType[]
    {
      RESTRICTIVE,
      PERMISSIVE,
  ...
  public static ResolutionType get(int value)
  {
    switch (value)
    {
      case RESTRICTIVE_VALUE: return RESTRICTIVE;
