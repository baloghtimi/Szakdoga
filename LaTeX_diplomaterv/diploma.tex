...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Balogh Tímea}
\newcommand{\vikkonzulens}{Debreceni Csaba}
\newcommand{\vikbeosztasa}{MTA-BME Lendület}
\newcommand{\vikbeosztasb}{Kiber-fizikai Rendszerek Kutatócsoport}
\newcommand{\vikcim}{Modellelemek effektív jogosultságainak származtatása finomszemcsés hozzáférési szabályokból}
\newcommand{\viktanszek}{Méréstechnika és Információs Rendszerek Tanszék}
\newcommand{\vikdoktipus}{Szakdolgozat}
\newcommand{\vikdepartmentr}{Balogh Tímea}
...
\setlength{\parskip}{4pt}    % magyar nyelvû dokumentumokban jellemzõ
...
%} 		
\def\lstlistingname{Forráskód}
\include{commons/lstlistings}
...
\input{src/conclusionandfuturework}
