 ...
 * @generated
 */
public class SeniorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Senior_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Senior_name_feature", "_UI_Senior_type"),
				 FreshmanCampPackage.Literals.SENIOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Senior_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Senior_color_feature", "_UI_Senior_type"),
				 FreshmanCampPackage.Literals.SENIOR__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
